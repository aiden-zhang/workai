...
{	
	...
	static void bin_count(dim3 grid,dim3 block,
		...
		switch(current_bin_size){
			case 4: radix_sort_bincount<DataType,IsAscending,BLOCK_SIZE,TILE_NUM,4,BIN_COUNTER_DATATYPE,4,PreProcess>
			    			<<<grid,block,0,*stream>>>(data_dev,bin_count_dev,total_num,BIN_START_IDX);break;

		    case 16: radix_sort_bincount<DataType,IsAscending,BLOCK_SIZE,TILE_NUM,16,BIN_COUNTER_DATATYPE,4,PreProcess>
			    			<<<grid,block,0,*stream>>>(data_dev,bin_count_dev,total_num,BIN_START_IDX);break;

			case 32: radix_sort_bincount<DataType,IsAscending,BLOCK_SIZE,TILE_NUM,32,BIN_COUNTER_DATATYPE,4,PreProcess>
			    			<<<grid,block,0,*stream>>>(data_dev,bin_count_dev,total_num,BIN_START_IDX);break;

			case 64: radix_sort_bincount<DataType,IsAscending,BLOCK_SIZE,TILE_NUM,64,BIN_COUNTER_DATATYPE,4,PreProcess>
			    			<<<grid,block,0,*stream>>>(data_dev,bin_count_dev,total_num,BIN_START_IDX);break;
		}
	...
	static void csum(int32_t current_bin_size,
		...
		{
			case 4: radix_sort_csum<BIN_COUNTER_DATATYPE,512,4>
	...
	static void reorder_without_idxs(dim3 grid,dim3 block,
			...
			,void* DebugMem=nullptr
		        ...
		        switch(current_bin_size){
					case 4: raidx_sort_reorder<DataType,IndxType,IsAscending,BLOCK_SIZE,TILE_NUM,
			    	...
			    	case 16: raidx_sort_reorder<DataType,IndxType,IsAscending,BLOCK_SIZE,TILE_NUM,
				    ...
				    case 32: raidx_sort_reorder<DataType,IndxType,IsAscending,BLOCK_SIZE,TILE_NUM,
				    ...
				    case 64: raidx_sort_reorder<DataType,IndxType,IsAscending,BLOCK_SIZE,TILE_NUM,
...
template int32_t RadixSortFunc<float, uint64_t, false>(float* data_dev, uint64_t* indxs_dev, int32_t total_num,
	float* data_out_dev=nullptr,
	uint64_t* indxs_out_dev=nullptr,
	void* workspace_dev=nullptr,
	cudaStream_t* stream=nullptr);
