...
Expr MakeDlNonMaxSuppressionNNE_(Expr boxes_gather, Expr sorted_scores,
  ...
  attrs->sorted = sorted;
  static const Op &op = Op::Get("custom_non_max_suppression");
  return Call(op,
...
TVM_REGISTER_GLOBAL("relay.op._make.custom_non_max_suppression")
    .set_body_typed(MakeDlNonMaxSuppressionNNE_);
...
RELAY_REGISTER_OP("custom_non_max_suppression")
