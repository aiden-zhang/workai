...
TVM_REGISTER_GLOBAL("dl.relay.op._make.custom_filter_sort").set_body_typed(MakeDlCustomFilterSort);  

bool DlCustomFilterSortRel(const Array<Type> &types, int num_inputs, const Attrs &attrs, const TypeReporter &reporter) 
{
