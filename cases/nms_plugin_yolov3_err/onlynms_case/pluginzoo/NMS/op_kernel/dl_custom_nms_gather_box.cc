...
struct DlNonMaxSuppressionGatherBoxesNNEAttrs: public tvm::AttrsNode<DlNonMaxSuppressionGatherBoxesNNEAttrs> 
{
  TVM_DECLARE_ATTRS(DlNonMaxSuppressionGatherBoxesNNEAttrs, "relay.attrs.DlNonMaxSuppressionGatherBoxesNNEAttrs") {}
};

TVM_REGISTER_NODE_TYPE(DlNonMaxSuppressionGatherBoxesNNEAttrs);

Expr MakeDlNonMaxSuppressionGatherBoxesNNE(Expr boxes, Expr sorted_idx, Expr sort_size) 
{
...
TVM_REGISTER_GLOBAL("dl.relay.op._make.custome_non_max_suppression_gather_boxes").set_body_typed(MakeDlNonMaxSuppressionGatherBoxesNNE);
...
RELAY_REGISTER_OP("dl.custome_non_max_suppression_gather_boxes")
    ...
    TVM_REGISTER_GLOBAL("dl.caffe.custome_non_max_suppression_gather_boxes_cpu")
