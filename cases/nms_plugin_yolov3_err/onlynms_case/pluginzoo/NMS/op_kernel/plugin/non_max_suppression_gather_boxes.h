...
class YoloV3NonMaxSuppressionGatherBoxPlugin : public PluginExt {
 public:
  ...
  int Initialize() override {
    ...
    // if (getenv("DLNMS_PLUGIN_KERNEL_PATH") == nullptr) {
    //   DebugInfo(" error: not export DLNMS_PLUGIN_KERNEL_PATH");
    //   assert(false);
    // } else {
    //   plugin_kernel_path = std::string(getenv("DLNMS_PLUGIN_KERNEL_PATH"));
    // }
    ...
    //               << std::endl;
    func_template << gather_boxes_src_file << std::endl;
    func_template
