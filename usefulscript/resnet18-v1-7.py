...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default="./resnet18-v1-7.onnx", help="onnx model file")
    ...
    parser.add_argument('--out_node', type=str, default="resnetv15_dense0_fwd", help="set output node")
